            ...
            with torch.no_grad():
                if args.use_amp:
                    ...
                    for cls in range(args.num_classes):
                        dice_scores[cls].append(dice_scores_batch[cls].item().detach().cpu().numpu())  # Store individual Dice score for the batch
                    mean_dice_scores.append(mean_dice_score.item())  # Store average Dice score for the batch
                    list_perclass_dice_scores_batch.append(dice_scores_batch)
