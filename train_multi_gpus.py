...
tr_dataset = NpyDataset("/data/home/umang/Vader_umang/Seg_models/data/CTScans/preprocessed_RGB")
...
parser.add_argument("-pretrain_model_path", type=str, default="/data/home/umang/Vader_umang/Seg_models/MedSAM/sam_vit_b_01ec64.pth")
    ...
    def forward(self, image, box):
        ...
        with torch.no_grad():
            ...
            if len(box_torch.shape) == 2:
                box_torch = box_torch[:, None, :]  # (B, 1, 4)  - select one.
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    sam_model = sam_model_registry[args.model_type](image_size=1024,
                                                    num_classes=4,
                                                    checkpoint=args.checkpoint, 
                                                    pixel_mean=[0, 0, 0],
                                                    pixel_std=[1, 1, 1])

    # Define a new class that utilizes declarations from sam model.
    medsam_model = MedSAM(
