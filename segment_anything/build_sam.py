...
def _build_sam(
    ...
    if checkpoint is not None:
        ...
        try:
            sam.load_state_dict(state_dict)  # Should be able to load a trained sam file ckpt.
        except:
...
def load_from(sam, state_dict, image_size, vit_patch_size):
    ...
    if pos_embed.shape[1] != token_size:
        ...
        print("pos embed and token size don't match, interpolating pos embed to token size")
